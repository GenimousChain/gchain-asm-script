(module
 ...
 (data (i32.const 368) "(\00\00\00\01\00\00\00\01\00\00\00(\00\00\00s\00t\00d\00/\00a\00r\00r\00a\00y\00-\00b\00r\00a\00c\00k\00e\00t\00.\00t\00s\00")
 (data (i32.const 424) "&\00\00\00\01\00\00\00\01\00\00\00&\00\00\00~\00l\00i\00b\00/\00a\00r\00r\00a\00y\00b\00u\00f\00f\00e\00r\00.\00t\00s\00")
 (data (i32.const 480) "\05\00\00\00\10\00\00\00\00\00\00\00\10\00\00\00\00\00\00\00\10\00\00\00\00\00\00\003\00\00\00\02\00\00\00\93\04\00\00\02\00\00\00")
 (table $0 1 funcref)
 ...
 (func $~lib/array/Array<u8>#push (; 32 ;) (type $FUNCSIG$iii) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  local.get $0
  i32.load offset=12
 ...
 (func $std/array-bracket/toArray (; 33 ;) (type $FUNCSIG$ii) (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  i32.const 0
 ...
 (func $~lib/array/Array<u8>#constructor (; 36 ;) (type $FUNCSIG$iii) (param $0 i32) (param $1 i32) (result i32)
  local.get $0
  if (result i32)
   local.get $0
  else
 ...
 (func $std/array-bracket/newArray (; 37 ;) (type $FUNCSIG$ii) (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  i32.const 0
  i32.const 0
 ...
 (func $start:std/array-bracket (; 38 ;) (type $FUNCSIG$v)
  (local $0 i32)
  i32.const 12
  call $std/array-bracket/toArray
  global.set $std/array-bracket/arr
  global.get $std/array-bracket/arr
 ...
 (func $start (; 39 ;) (type $FUNCSIG$v)
  call $start:std/array-bracket
 )
 (func $~lib/array/Array<u8>#__visit_impl (; 40 ;) (type $FUNCSIG$vii) (param $0 i32) (param $1 i32)
  nop
 )
 (func $~lib/array/Array<i32>#__visit_impl (; 41 ;) (type $FUNCSIG$vii) (param $0 i32) (param $1 i32)
  nop
 )
