(module
 ...
 (func $rc/optimize/eliminated_rr (; 34 ;) (type $FUNCSIG$ii) (param $0 i32) (result i32)
  call $rc/optimize/getRef
 )
 (func $rc/optimize/OptimizeARC.keeps.partialRetains (; 35 ;) (type $FUNCSIG$vii) (param $0 i32) (param $1 i32)
  local.get $1
  if (result i32)
   local.get $0
   call $~lib/rt/pure/__retain
 ...
 (func $rc/optimize/OptimizeARC.keeps.reachesReturn (; 36 ;) (type $FUNCSIG$iii) (param $0 i32) (param $1 i32) (result i32)
  local.get $0
  call $~lib/rt/pure/__retain
  local.set $0
  local.get $1
 ...
 (func $rc/optimize/FinalizeARC.keeps.dynamicRetain (; 37 ;) (type $FUNCSIG$vi) (param $0 i32)
  local.get $0
  call $~lib/rt/pure/__retain
  drop
 )
 (func $rc/optimize/FinalizeARC.keeps.dynamicRelease (; 38 ;) (type $FUNCSIG$vi) (param $0 i32)
  local.get $0
  call $~lib/rt/pure/__release
 )
